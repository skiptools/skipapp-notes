...
fileprivate let logger: Logger = Logger(subsystem: "org.appfair.app.SkipNotes", category: "SkipNotes")
...
public struct SkipNotesRootView : View {
    @ObservedObject var appDelegate = SkipNotesAppDelegate.shared
...
public class SkipNotesAppDelegate: ObservableObject {
